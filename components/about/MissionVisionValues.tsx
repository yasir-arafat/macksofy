...
const ITEMS = [
  {
    ...
    body: "Build the talent, deliver the assurance, and harden the institutions that India and the GCC depend on — through training that produces practitioners and consulting that produces measurable outcomes.",
    icon: Compass,
    accent: "cyan",
  },
  {
    ...
    body: "A cybersecurity firm whose reports are accepted by every Indian regulator on the first read, and whose alumni are running the SOCs, red teams and AppSec functions of every major Indian bank, fintech and government body.",
    icon: Telescope,
    accent: "purple",
  },
  {
    ...
    body: "Ship work we are proud to put our name on. Stay with the customer past sign-off. Stay with the student past the exam. Never resell what we cannot teach.",
    icon: Sparkles,
    accent: "amber",
  },
] as const;
...
const ACCENT = {
  ...
  amber: {
    text: "text-amber-300",
    grad: "from-amber-300/20 to-transparent",
    ring: "ring-amber-300/40",
    glow: "shadow-[0_0_60px_rgba(252,211,77,0.35)]",
  },
} as const;
