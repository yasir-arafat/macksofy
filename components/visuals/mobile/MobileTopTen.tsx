...
const ITEMS: Item[] = [
  ...
  { code: "M5", name: "Insecure Communication", detail: "TLS pinning bypass, cleartext fallback, custom-CA acceptance", android: 75, ios: 78 },
  { code: "M6", name: "Inadequate Privacy Controls", detail: "Over-broad permissions, background data leakage, PII in logs", android: 85, ios: 75 },
  { code: "M7", name: "Insufficient Binary Protection", detail: "No root/jailbreak detection, missing anti-debug, weak obfuscation", android: 70, ios: 60 },
  { code: "M8", name: "Security Misconfiguration", detail: "Debuggable=true in release, exported components, dev endpoints", android: 82, ios: 55 },
  { code: "M9", name: "Insecure Data Storage", detail: "SharedPreferences / NSUserDefaults secrets, world-readable SQLite", android: 90, ios: 80 },
  { code: "M10", name: "Insufficient Cryptography", detail: "ECB mode, hard-coded IVs, custom crypto, key derivation flaws", android: 78, ios: 72 },
];
