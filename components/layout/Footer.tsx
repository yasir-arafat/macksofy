...
const SOCIALS = [
  ...
  {
    name: "X (Twitter)",
    href: "https://twitter.com/macksofy",
    color: "hover:text-fg",
    Icon: (props: React.SVGProps<SVGSVGElement>) => (
      <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden {...props}>
  ...
  {
    name: "Facebook",
    href: "https://www.facebook.com/macksofytechnologies",
  ...
  {
    name: "Instagram",
    href: "https://www.instagram.com/macksofytechnologies",
  ...
  {
    name: "YouTube",
    href: "https://www.youtube.com/@macksofy",
    color: "hover:text-[#FF0000]",
    Icon: (props: React.SVGProps<SVGSVGElement>) => (
      <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden {...props}>
        <path d="M23.5 6.2a3 3 0 0 0-2.12-2.13C19.51 3.55 12 3.55 12 3.55s-7.5 0-9.38.52A3 3 0 0 0 .5 6.2 31.4 31.4 0 0 0 0 12a31.4 31.4 0 0 0 .5 5.8 3 3 0 0 0 2.12 2.13c1.88.52 9.38.52 9.38.52s7.5 0 9.38-.52a3 3 0 0 0 2.12-2.13c.34-1.9.5-3.83.5-5.8a31.4 31.4 0 0 0-.5-5.8zM9.6 15.57V8.43L15.82 12 9.6 15.57z" />
      </svg>
    ),
  },
];
