...
export const COURSES: Course[] = [
...

  {
    ...
    faqs: [
      ...
      { q: "What's next after OSCP+ in 2026?", a: "Three common paths: (1) Web specialisation — OSWA → OSWE; (2) Red team — OSEP (PEN-300); (3) Exploit dev / vulnerability research — OSED → OSMR / OSEE. We help you pick at the end of the OSCP bootcamp based on your strengths and target roles." },
...

  {
    ...
    faqs: [
      ...
      { q: "What's after OSEP?", a: "Common paths: (1) OSED → OSMR / OSEE for vulnerability research; (2) GXPN / GREM for SANS-track red teamers; (3) bug-bounty specialisation with OSWE; (4) Macksofy's senior consulting track for adversary-emulation leadership roles." },
...

  {
    ...
    faqs: [
      ...
      { q: "What's after OSED?", a: "Two paths: (1) OSMR for macOS specialisation, OSEE for advanced Windows / kernel exploitation; (2) SANS GREM for malware-RE depth. Bug-bounty hunters often combine OSED with hardware-hacking specialisation." },
...

  {
    ...
    faqs: [
      ...
      { q: "What's after OSMR?", a: "Common paths: OSEE for advanced Windows kernel-track depth, deep specialisation in iOS / Apple-platform security research, or rolling OSMR into a senior red-team / vulnerability-research role at a product-security org." },
    ],
...

  {
    ...
    testimonials: [],
    faqs: [
      { q: "What is the cost of OSEE / EXP-401 in 2026?", a: "EXP-401 / OSEE is OffSec's most expensive course — historically ~$10,000+ USD for the in-person training week, plus exam fees. Macksofy facilitates enrolment and provides pre- and post-training mentorship at our standard ₹1,45,000 mentorship package; the OffSec course fee is paid separately to OffSec." },
      { q: "Is OSEE delivered in India?", a: "OSEE is classroom-only and offered by OffSec at select global locations (most commonly the US and Europe alongside major security conferences). Macksofy India coordinates enrolment, travel logistics and 1:1 pre-training prep for OSEE candidates." },
      { q: "Why is OSEE considered the hardest OffSec cert?", a: "OSEE covers kernel exploitation, sandbox escapes, browser RE, modern mitigation bypass (CFG, ACG, CET) and pool-overflow exploitation — the highest end of the offensive-security skill stack. The 72-hour exam against custom targets is rumoured to have a sub-30% first-attempt pass rate." },
      { q: "Do I need OSED before OSEE?", a: "Yes — OSED is the standard prerequisite. Without fluent x86 / x64 assembly + IDA + WinDbg + ROP-chain construction skills, OSEE is unattainable. Macksofy gates entry to its OSEE prep track on OSED completion." },
      { q: "What jobs does OSEE unlock?", a: "Senior Vulnerability Researcher (₹40–80 LPA), Elite Exploit Developer (₹50 LPA+ to 1 Cr+ for top researchers). Common destinations: Microsoft MSRC, Apple SEAR, Google Project Zero, ZDI, Indian boutique VR firms (SecureLayer7, Yogosha-aligned). Many OSEE holders work for offensive cyber-defence or government research orgs." },
      { q: "What's after OSEE?", a: "OSEE is essentially the OffSec ceiling. Most holders move into independent vulnerability research, found their own VR boutique, lead red-team / exploit-dev teams or deepen into specialised areas (firmware, hypervisor, baseband)." },
      { q: "What does Macksofy's OSEE prep package include?", a: "1:1 mentorship from OSED-cleared instructors, custom self-study roadmap, weekly progress reviews, exam-day logistics support and post-exam debrief — for the 4–6 month window leading into the OSEE classroom." },
    ],
    seoTitle: "OSEE Training in India 2026 | OffSec EXP-401 Advanced Windows Exploitation | Macksofy",
    seoDescription: "OffSec OSEE / EXP-401 advanced Windows exploitation prep in India 2026 by Macksofy. Kernel exploitation, sandbox escape, CFG / ACG / CET bypass. 72-hour exam. Macksofy facilitates enrolment + 1:1 prep mentorship.",
    keywords: [
      "OSEE training India",
      "OSEE certification India 2026",
      "EXP-401 training India",
      "OffSec EXP-401",
      "OSEE prep India",
      "advanced Windows exploitation course",
      "kernel exploitation training India",
      "Windows kernel exploit dev",
      "OSEE vs GXPN",
      "OSEE classroom training",
      "OSEE bootcamp India",
      "OSEE jobs",
      "OSEE salary India",
      ...metroKeywords("OSEE prep"),
      ...metroKeywords("kernel exploitation training"),
    ],
  },
