...
def fetch_logs(service: str) -> str:
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: "cta", title: "Download the one-page brief", text: "Prefer a PDF to share with your CISO or board? Grab the Macksofy-branded brief — the tiered schedule, the collapsing-exploit-window data, the compensating-control path and the 30/60/90-day action list on two pages, sources cited.", href: "/cert-in-12-hour-patch-mandate-macksofy-brief.pdf", cta: "Download PDF brief" },
